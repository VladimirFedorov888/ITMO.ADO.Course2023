...
namespace ITMO.ADO2023.Task01.Ex02
{
    public partial class Form1 : Form
    {
        ...
        //string testConnect = @"Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=Northwind;Data Source=BLACK-CRYSTAL\SQLEXPRESS";
        public Form1()
        {
            InitializeComponent();
